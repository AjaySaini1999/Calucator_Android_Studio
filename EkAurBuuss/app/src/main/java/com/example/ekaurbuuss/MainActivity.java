                ...
                case "":
                    if (sCalculation.equals("")) {
                        ...
                        switch (function) {
                            ...
                            case "sin":
                                if (RorD.equals("DEG")) {
                                    numberOne = numberOne*3.14159/180;
                                }
                                temp = Result + Math.round(Math.sin(numberOne)*10000)/10000.0;
                                sCalculation = "sin( " + number_one;
                                break;

                            case "sin_inv":
                                if (RorD.equals("DEG")) {
                                    temp = Result + Math.toDegrees(Math.asin(numberOne));
                            ...
                            case "cos":
                                ...
                                temp = Result + Math.round(Math.cos(numberOne)*10000)/10000.0;
                                sCalculation = "cos( " + number_one;
                                break;

                            case "cos_inv":
                                if (RorD.equals("DEG")) {
                                    temp = Result + Math.toDegrees(Math.acos(numberOne));
                            ...
                            case "tan":
                                ...
                                temp = Result + Math.round(Math.tan(numberOne)*10000)/10000.0;
                                sCalculation = "tan( " + number_one;
                                break;

                            case "tan_inv":
                                if (RorD.equals("DEG")) {
                                    temp = Result + Math.toDegrees(Math.atan(numberOne));
